...
public class HomePage extends BasePage{
    ...
    private final By COUNTRY_TEXT= By.xpath("//input[@placeholder='Type to Select Countries']");
    ...
    public String enterCountry(){
        wait.until(ExpectedConditions.visibilityOfElementLocated(COUNTRY_TEXT)).sendKeys("India");
        String s = "India";
        return s;
    }
}
